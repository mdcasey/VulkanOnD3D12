...
#if defined(__LP64__) || defined(_WIN32) || (defined(__x86_64__) && !defined(__ILP32__) ) || defined(_M_X64) || defined(__ia64) || defined (_M_IA64) || defined(__aarch64__) || defined(__powerpc64__)
...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_UWP_SURFACE_CREATE_INFO_CHB = 1000153000,
...
#define VK_CHB_uwp_surface 1
#define VK_CHB_UWP_SURFACE_SPEC_VERSION   1
#define VK_CHB_UWP_SURFACE_EXTENSION_NAME "VK_CHB_uwp_surface"

typedef VkFlags VkUWPSurfaceCreateFlagsCHB;

typedef struct VkUWPSurfaceCreateInfoCHB {
    VkStructureType               sType;
    const void*                   pNext;
    VkUWPSurfaceCreateFlagsCHB    flags;
    IUnknown*                     window;
} VkUWPSurfaceCreateInfoCHB;


typedef VkResult (VKAPI_PTR *PFN_vkCreateUWPSurfaceCHB)(VkInstance instance, const VkUWPSurfaceCreateInfoCHB* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface);
typedef VkBool32 (VKAPI_PTR *PFN_vkGetPhysicalDeviceUWPPresentationSupportCHB)(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex);
...
#define VK_CHB_dxbc_shader 1
#define VK_CHB_DXBC_SHADER_SPEC_VERSION   1
#define VK_CHB_DXBC_SHADER_EXTENSION_NAME "VK_CHB_dxbc_shader"
